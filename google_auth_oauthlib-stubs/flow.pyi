...
class Flow:
  ...
  def __init__(self,
               ...
               autogenerate_code_verifier: bool = ...) -> None:
    ...

  @classmethod
  def from_client_config(cls, client_config: Mapping[str, Any],
                         scopes: Sequence[str], **kwargs: Any) -> Self:
    ...

  @classmethod
  def from_client_secrets_file(cls, client_secrets_file: str,
                               scopes: Sequence[str], **kwargs: Any) -> Self:
    ...
...
class _RedirectWSGIApp:
  ...
  def __call__(self, environ: Mapping[str, Any],
               start_response: Callable[[str], list[Any]]) -> list[str]:
    ...
